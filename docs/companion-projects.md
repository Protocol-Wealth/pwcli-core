...
- Nick Rygiel role: Managing Partner / CTO, Certified Financial Planner professional

## Repositories

| Project | URL | Relationship to pwcli-core |
| --- | --- | --- |
| nexus-core | https://github.com/Protocol-Wealth/nexus-core | Potential reference for deterministic analytics and tool-facing services. |
...
These projects are references, not dependencies. `pwcli-core` examples must stay
generic and synthetic unless a future adapter explicitly declares otherwise.
